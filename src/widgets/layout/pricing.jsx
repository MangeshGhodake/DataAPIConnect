  ...
  return (
    <section className="bg-white dark:bg-gray-900">
      <div className="mx-auto max-w-screen-2xl px-4 py-8 lg:px-6 lg:py-16">
        ...
        <div className="space-y-8 sm:gap-4 lg:grid lg:grid-cols-4 lg:space-y-0 xl:gap-8">
          <div className="mx-auto flex max-w-lg flex-col rounded-lg border border-gray-100 bg-white p-6 text-center text-gray-900 shadow dark:border-gray-600 dark:bg-gray-800 dark:text-white xl:p-8">
            <h3 className="mb-4 text-2xl font-semibold">Pay As You Go</h3>
            <p className="font-light text-gray-500 dark:text-gray-400 sm:text-lg">
              No subscriptoin,
              <br /> No commitment.
            </p>
            <div className="my-8 flex items-baseline justify-center">
              <span className="mr-2 text-5xl font-extrabold">$0.10</span>
            ...
            <a
              href="#"
              className="bg-primary-600 hover:bg-primary-700 focus:ring-primary-200 rounded-lg px-5 py-2.5 text-center text-sm font-medium focus:ring-4"
            >
              Start Now
            </a>
          </div>
          <div className="mx-auto flex max-w-lg flex-col rounded-lg border border-gray-100 bg-white p-6 text-center text-gray-900 shadow dark:border-gray-600 dark:bg-gray-800 dark:text-white xl:p-8">
            ...
            <div className="my-8 flex items-baseline justify-center">
              <span className="mr-2 text-5xl font-extrabold">$0.08</span>
          ...
          <div className="mx-auto flex max-w-lg flex-col rounded-lg border border-gray-100 bg-white p-6 text-center text-gray-900 shadow dark:border-gray-600 dark:bg-gray-800 dark:text-white xl:p-8">
            ...
            <div className="my-8 flex items-baseline justify-center">
              <span className="mr-2 text-5xl font-extrabold">$0.06</span>
              <span className="text-gray-500 dark:text-gray-400">/record</span>
            </div>
            <ul role="list" className="mb-8 space-y-4 text-left">
              <li className="flex items-center space-x-3">
          ...
          <div className="mx-auto flex max-w-lg flex-col rounded-lg border border-gray-100 bg-white p-6 text-center text-gray-900 shadow dark:border-gray-600 dark:bg-gray-800 dark:text-white xl:p-8">
            ...
            <div className="my-8 flex items-baseline justify-center">
              <span className="mr-2 text-5xl font-extrabold">$0.04</span>
              <span className="text-gray-500 dark:text-gray-400">/record</span>
            </div>
            <ul role="list" className="mb-8 space-y-4 text-left">
              <li className="flex items-center space-x-3">
...
Pricing.displayName = "/src/widgets/layout/pricing.jsx";
